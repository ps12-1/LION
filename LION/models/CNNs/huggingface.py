...
class Swin2SR(LIONmodel):
    ...
    def __init__(
        ...
        cache_dir = "/store/LION/ps2050/.cache/huggingface"
    ...
    def default_parameters() -> LIONModelParameter:
        ...
        # HF cache location
        params.hf_cache_dir = "/store/LION/ps2050/.cache/huggingface"
    ...
    def cite(cite_format="MLA"):
        if cite_format == "MLA":
            ...
            print(
                "AIM 2022 Challenge on Super-Resolution of Compressed Image and Video (2022)."
            )
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        ), "Swin2SR expects single-channel CT inputs"
        ...
        if recon_gray.shape[-2] != h or recon_gray.shape[-1] != w:
            recon_gray = nn.functional.interpolate(
                recon_gray, size=(h, w), mode="bilinear", align_corners=False
            )
